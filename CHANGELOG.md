...
- Generated projects build on `golang:1.25-alpine` instead of `1.22-alpine`, in
  both `Dockerfile` and `Dockerfile.dev`. The generated `go.mod` still declares
  `go 1.22`, which a newer toolchain builds fine, so only the compiler in the
  container moved.
...
[Unreleased]: https://github.com/gos0001/gostack/compare/v0.3.1...HEAD
[0.3.1]: https://github.com/gos0001/gostack/compare/v0.3.0...v0.3.1
